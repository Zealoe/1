...
As shown in Fig.~\ref{zong}, our method consists of three modules, which are respectively an edge inpainting network (EdgeNet), a texture inpainting network (TexNet), and a flow inpainting network (FlowNet).
%
