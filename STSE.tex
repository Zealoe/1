...
\begin{figure*}[t]
	\centering
	\includegraphics[width=2.0\columnwidth]{zong} % Reduce the figure size so that it is slightly narrower than the column. Don't use precise values for figure width.This setup will avoid overfull boxes. 
