...
\begin{abstract}
	...
	Specifically, STSENet first synthesizes missing optical flow and detailed edge across frames, which are associated with a flow-edge consistency constraint for mutual improvements.
	Then, both edge-preserved flow and temporal coherent edge are used to promote video frame generation, via a structure enhancement mechanism and a flow-guided propagation.
