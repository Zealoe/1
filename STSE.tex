...
%/Title (Structure-Guided Deep Video Inpainting)
/Title (Structure-Guided Deep Video Inpainting)
...
%\title{Structure-Guided Video Inpainting by Learning Spatio-Temporal Edges}
...
To produce visually plausible content in the missing region, we first synthesize edge maps that well represent scene structure and object shapes by applying an edge inpainting network with 3D convolutions to video volume. 
